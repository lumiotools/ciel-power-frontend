...
export default function BookingDetailsPage({ params }: { params: Promise<{ bookingNumber: string }> }) {
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="grid gap-8">
            ...
            <div className="pt-6 border-t flex justify-end gap-3">
              ...
              <Button onClick={handleSaveChanges} className="bg-[#5cb85c] hover:bg-[#4a9d4a] px-6" disabled={isSaving}>
                {isSaving ? (
                  <>
