      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <div className="flex items-center mt-2">
            ...
            <span className="ml-2 text-gray-600">4.9 rating of 39 reviews</span>
          </div>
        </div>
      ...
      <div className="relative">
        <div className="flex space-x-6 overflow-x-auto pb-4 hide-scrollbar">
          <div className="bg-white rounded-lg border border-[#e0f0d0] p-6 min-w-[350px] max-w-[350px] flex flex-col">
            ...
            <p className="text-gray-600 mb-4 flex-grow">
              The energy auditor was thorough and professional. They identified
              several areas where we could improve efficiency. After
              implementing their recommendations, our energy bills dropped by
              25%! Highly recommend Ciel Power.
            </p>
          ...
          <div className="bg-white rounded-lg border border-[#e0f0d0] p-6 min-w-[350px] max-w-[350px] flex flex-col">
            ...
            <p className="text-gray-600 mb-4 flex-grow">
              Our home was always cold in winter despite cranking up the heat.
              The Ciel Power audit revealed poor insulation and air leaks. After
              fixing these issues, our home stays warm and comfortable with much
              lower heating costs. 10/10!
            </p>
            <div className="flex justify-end">
              <svg className="w-6 h-6" viewBox="0 0 24 24">
                <path
          ...
          <div className="bg-white rounded-lg border border-[#e0f0d0] p-6 min-w-[350px] max-w-[350px] flex flex-col">
            ...
            <p className="text-gray-600 mb-4 flex-grow">
              Mark from Ciel Power was knowledgeable and friendly. The thermal
              imaging showed exactly where we were losing energy. The detailed
              report helped us prioritize upgrades. Our home is now more
              comfortable and efficient...
              <span className="text-[#8bc34a] cursor-pointer">See more</span>
            </p>
            <div className="flex justify-end">
              <svg className="w-6 h-6" viewBox="0 0 24 24">
                <path
          ...
          <div className="bg-white rounded-lg border border-[#e0f0d0] p-6 min-w-[350px] max-w-[350px] flex flex-col">
            ...
            <p className="text-gray-600 mb-4 flex-grow">
              We were skeptical about the value of an energy audit, but it was
              worth every penny. Ciel Power identified issues we never would
              have found ourselves. The rebates they helped us get covered most
              of the audit cost. Excellent service!
            </p>
            <div className="flex justify-end">
              <svg className="w-6 h-6" viewBox="0 0 24 24">
                <path
        ...
        <button className="absolute left-0 top-1/2 -translate-y-1/2 -ml-4 w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center z-10 border border-[#e0f0d0]">
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="lucide lucide-chevron-down rotate-90 text-[#8bc34a]"
          >
