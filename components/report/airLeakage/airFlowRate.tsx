          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex-1">
              <p className="text-gray-700 mb-4">
                ...
                healthy ventilation. Airflow rates above these levels create
                excessive strain on heating & cooling systems.
              </p>
              <div className="flex items-center">
                <div className="w-48 h-3 bg-gray-200 rounded-md overflow-hidden mr-3">
                  ...
                  {/* <div
                    ...
                    style={{ backgroundColor: "#031A821A" }}
                  ></div> */}
                </div>
                <span className="text-[#031A82] font-medium">
                  Recommended: 35%
                </span>
              </div>
            </div>
