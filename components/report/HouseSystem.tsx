  ...
  const systems = [
    {
      ...
      icon: Wind,
      title: "Ventilation",
      description: "Proper ventilation is necessary to exhaust moisture & exhaust gasses from the home",
      color: "text-[#824EA0]",
      bgColor: "bg-teal-400",
      position: "top",
      image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Ventilation-PA6NMrGZ5x4U0pafNsCIZG7fiN92nn.png",
    },
    {
      id: "cooling",
      icon: Snowflake,
      title: "Air-Conditioning",
      description: "Air conditioning systems struggle to cool poorly insulated areas",
      color: "text-[#824EA0]",
      bgColor: "bg-blue-400",
      position: "middle",
      image:
    ...
    },
    {
      ...
      items: ["Air Leakage", "Foundation", "Wall Insulation", "Attic Insulation", "Buffered Walls"],
      color: "text-[#824EA0]",
    ...
    },
    {
      ...
      description: "More energy is consumed in poorly insulated homes as the heating system fires more frequently",
      color: "text-[#824EA0]",
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-100 mb-6 overflow-hidden">
      <div className="p-5" style={{ backgroundColor: "#824EA01A" }}>
        <h2 className="font-medium" style={{ color: "#824EA0" }}>Building Science: A &quot;House as a System&quot; Approach</h2>
      </div>
      <div className="p-5">
        ...
        <div className="mb-12">
          ...
          >
            You understand that your car is made up of interacting components and systems– when one component fails, it
            affects the performance of the entire vehicle. Do you know that the same goes for your house? If one system
            has a problem, it impacts the other systems&apos; ability to function properly.
          </motion.p>
        </div>
            ...
            {systems.map((system, index) => (
              <motion.button
                ...
                className={`flex items-center gap-4 p-4 rounded-lg transition-all ${
                  activeSystem === system.id ? "text-[#824EA0]" : "hover:bg-gray-50"
                }`}
                style={activeSystem === system.id ? { backgroundColor: "#824EA01A" } : {}}
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              <map name="house-map">
                <area
                  ...
                  style={{
                    cursor: "pointer",
                    fill: activeSystem === "ventilation" ? "#67B502" : "transparent",
                    fillOpacity: "0.2",
                  }}
                />
                ...
                <area
                  ...
                  style={{
                    cursor: "pointer",
                    fill: activeSystem === "cooling" ? "#67B502" : "transparent",
                    fillOpacity: "0.2",
                  }}
                />
                ...
                <area
                  ...
                  style={{
                    cursor: "pointer",
                    fill: activeSystem === "building-shell" ? "#67B502" : "transparent",
                    fillOpacity: "0.2",
                  }}
                />
              </map>
            ...
            {activeSystem && (
              ...
              >
                <div className="bg-white/95 backdrop-blur-sm p-6 rounded-lg shadow-sm max-w-sm mx-2 border border-gray-100">
                  <h3 className="font-medium text-sm mb-3" style={{ color: "#824EA0" }}>
                  ...
                  {systems.find((s) => s.id === activeSystem)?.items ? (
                    ...
                    <p className="text-sm text-gray-600">{systems.find((s) => s.id === activeSystem)?.description}</p>
                  )}
                </div>
              </motion.div>
            )}
