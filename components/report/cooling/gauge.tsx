...
interface ReportCoolingSectionGaugeProps {
  value: number
  minValue?: number
  maxValue?: number
  title?: string
    ...
    <div className="w-full aspect-[5/3] relative p-0 m-0 block" style={{ minHeight: "120px" }}>
      ...
      >
        ...
        <defs>
          ...
          <linearGradient id="cooling-gradient" x1="100%" y1="0%" x2="0%" y2="0%">
          ...
          {/* Arrow gradient */}
          <linearGradient id="cooling-arrow-gradient" x1="0%" y1="0%" x2="0%" y2="100%">
          ...
          <linearGradient id="cooling-dotted-gradient" x1="100%" y1="0%" x2="0%" y2="0%">
            <stop offset="0%" stopColor="#22c55e" /> {/* Green (low values) */}
            <stop offset="50%" stopColor="#eab308" /> {/* Yellow */}
        ...
        <motion.path
          ...
          fill="none"
          stroke="url(#cooling-dotted-gradient)"
          strokeWidth="1.5"
          strokeDasharray="3,6"
          style={{ margin: 0, padding: 0 }}
          initial={{ opacity: 0 }}
        ...
        >
          <path
            ...
            fill="url(#cooling-arrow-gradient)"
            stroke="none"
          />
        </g>
        ...
        >
          ...
          <tspan fill="#d47c02" fontWeight="700">
            {cooling?.current_value || displayedValue}
            {labelSuffix}
          </tspan>
        </motion.text>
      </motion.svg>
