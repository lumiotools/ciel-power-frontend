...
const ReportCoolingSectionCard = ({
  ...
  const defaultDescription = useMemo(
    ...
    [cooling.title, cooling.parameter, cooling.current_value, cooling.recommended_value],
  )
              ...
              <div className="bg-white p-4 rounded-md border border-gray-200">
                ...
                <div className="max-w-xl mx-auto flex justify-between gap-4 px-4 mt-3">
                  <div className="flex items-center gap-2">
                    <p className="text-sm text-gray-500">Current {cooling.parameter}</p>
                    <p className="text-xl font-bold text-[#F44336]">{cooling.current_value}</p>
                  </div>
                  <div className="flex items-center gap-2">
                    <p className="text-sm text-gray-500">BPI Recommends</p>
                    <p className="text-xl font-bold text-[#4CAF50]">{cooling.recommended_value}</p>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-2 gap-x-12 gap-y-2 p-4">
                  ...
                  <div>
                    {isAdmin ? (
                      ...
                      <p className="text-gray-800 !h-6 !py-0">{cooling.parameter}</p>
                    )}
                    <div className="text-[#d47c02] !font-bold">
                      {isAdmin ? (
                        <ReportEditableInput
