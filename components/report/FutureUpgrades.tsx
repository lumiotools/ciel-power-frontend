...
const solutions = [
  ...
  },
  {
    title: "Heat Pumps",
    description:
      "Electrification is a key trend, and heat pump technology plays a crucial role in this transition. As the technology evolves and incentive and credits become available, your assigned consultant will continue to provide you with the most up-to-date information. We encourage you to stay in touch and keep you informed of incentives and tax credits that may apply to your situation. We encourage regular check-ins with your Home Performance consultant to ensure that you are well-informed about the latest developments in heat pump technology and can take full advantage of available incentives and credits.",
    icon: Fan,
  },
  {
    title: "Appliances",
