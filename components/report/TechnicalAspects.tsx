    ...
    <div className="space-y-8">
      <Card>
        <CardHeader className="bg-teal-50 dark:bg-teal-900/20">
          <CardTitle className="text-2xl text-teal-600 dark:text-teal-300">Technical Aspects</CardTitle>
        </CardHeader>
          ...
          <div className="space-y-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-xl font-semibold text-teal-600 dark:text-teal-300">R-Value</h3>
              </div>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                A measure of resistance to the flow of heat through a given thickness of material (as insulation) with
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-teal-500 dark:text-teal-400 font-semibold">R-49</span>
                </div>
                <Progress value={75} className="h-2 bg-teal-100 dark:bg-teal-700" />
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-xl font-semibold text-teal-600 dark:text-teal-300">Thermal Imaging</h3>
              </div>
