          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-base font-medium text-[#00BFA5]">Enhanced Comfort</h3>
              </div>
              <p className="text-gray-700 text-sm">
                Properly installed insulation minimizes temperature variability indoors and helps keep rooms warmer in
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-base font-medium text-[#00BFA5]">Better Resale Position</h3>
              </div>
              <p className="text-gray-700 text-sm">
                The improved comfort, lower utility bills, and improved durability of a properly installed insulation
                barrier can translate into higher resale value compared to less efficient homes.
              </p>
            </div>
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-base font-medium text-[#00BFA5]">Lower Utility Bills</h3>
              </div>
              ...
              <div className="mt-auto">
                ...
                <Progress value={50} className="h-1.5 bg-[#44BFB83D]" />
              </div>
            </div>
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-base font-medium text-[#00BFA5]">Improved Durability</h3>
              </div>
              <p className="text-gray-700 text-sm mb-3">
              ...
              <div className="mt-auto">
                ...
                <Progress value={35} className="h-1.5 bg-[#44BFB83D]" />
              </div>
            </div>
          </div>
        </CardContent>
