            ...
            <Card className="h-[200px]">
              <CardContent className="p-6 flex flex-col h-full">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-teal-600 dark:text-teal-300">Enhanced Comfort</h3>
                </div>
                ...
                <p className="text-gray-600 dark:text-gray-300 flex-grow">
                  ...
                  <div className="mt-4">
                    <div className="flex justify-between text-sm mb-2">
                      ...
                      <span className="text-teal-500 dark:text-teal-400">35%</span>
                    </div>
              ...
              <CardContent className="p-6 flex flex-col h-full">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  ...
                  <div className="mt-4">
                    <div className="flex justify-between text-sm mb-2">
                      <span className="text-gray-600 dark:text-gray-400">Efficiency Impact</span>
                      <span className="text-teal-500 dark:text-teal-400">50%</span>
                    </div>
            ...
            <Card className="h-[200px]">
              <CardContent className="p-6 flex flex-col h-full">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-teal-600 dark:text-teal-300">Better Resale Position</h3>
                </div>
                <p className="text-gray-600 dark:text-gray-300 flex-grow">
