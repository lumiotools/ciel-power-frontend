...
const ReportInsulationSectionOverview = () => {
  return (
    <motion.div
        ...
        <CardContent className="p-5">
          <div className="flex flex-col md:flex-row items-start gap-6">
            <div className="flex-1 space-y-5">
              <div>
                <h3 className="text-lg font-medium text-[#00BFA5] mb-1">
                  What is Insulation?
                </h3>
              ...
              <blockquote className="border-l-4 border-[#00BFA5] pl-4 py-3 text-gray-700 bg-gray-50 rounded-r-md">
                ...
                <footer className="mt-2 text-sm text-[#256C68] italic">
                  — United States EPA
                </footer>
              </blockquote>
...
export default ReportInsulationSectionOverview;
