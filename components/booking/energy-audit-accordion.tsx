    ...
    <div className="flex flex-col gap-4 w-full">
      ...
      <div className="border border-[#e0f0d0] rounded-lg bg-[#f9fcf6]">
        <div className="p-4">
          ...
          {openSection === "gain" && (
            <div className="ml-12 mt-3 text-[#555]">
              ...
              <div className="flex justify-center mb-8">
                <div className="relative">
                  <div className="text-[#4caf50] text-[15px] italic mb-2 text-center">
                    <span className="text-2xl font-serif">&quot;</span> The
                    first step to accessing NJ&apos;s utility programs for
              ...
              <div className="mb-8">
                ...
                <p className="text-[#555] mb-4 leading-relaxed text-[15px]">
                  We understand that your home is more than just walls and
                  systems — it&apos;s where you and your family rest, breathe,
                  and recharge. Through the audit, we uncover opportunities to
                  help your home feel better, function better, and cost less to
                  run.
                </p>
              </div>
              ...
              <div className="mb-8">
                ...
                <ul className="mb-4 space-y-1 text-[#555] text-[15px]">
                  ...
                  <li className="flex items-start">
                    <span className="mr-2 text-[#555]">•</span>
                    <span>
                      Up to $25,000 in zero-interest financing for up to 10
                      years
                    </span>
                  </li>
                  <li className="flex items-start">
                ...
                <p className="text-[#555] mb-4 leading-relaxed text-[15px]">
                  We&apos;ll help you understand what you qualify for — and how
              ...
              <div className="mb-8">
                ...
                <p className="text-[#555] mb-4 leading-relaxed text-[15px]">
                  ...
                  it&apos;s also a step toward improving how you feel at home.
                  We assess how well your home manages airflow, temperature, and
                ...
                <ul className="mb-4 space-y-1 text-[#555] text-[15px]">
                  <li className="flex items-start">
                    <span className="mr-2 text-[#555]">•</span>
                    <span>
                      Fewer allergens and pollutants circulating through your
                      air
                    </span>
                  </li>
                  <li className="flex items-start">
                ...
                <p className="text-[#555] mb-4 leading-relaxed text-[15px]">
                  We understand that even small changes can make a big
                  difference. Whether it&apos;s helping you sleep more soundly
                  or making your home feel more balanced and breathable,
                  we&apos;re here to guide you toward solutions that fit your
                  lifestyle.
                </p>
              </div>
              ...
              <div className="mb-4">
                ...
                <p className="text-[#555] mb-4 leading-relaxed text-[15px]">
                  ...
                  tailored to your home. No dense reports, just useful
                  information you can act on when you&apos;re ready.
                </p>
              </div>
            </div>
          )}
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                ...
                <p className="text-gray-600">
                  ...
                  we&apos;ll move through your home and what we&apos;ll be
                  looking for.
                </p>
              </div>
            </div>
                    ...
                    <div className="flex">
                      ...
                      <div>
                        <p className="text-[#555] text-[15px]">
                          ...
                          on insulation, construction specifications, and
                    ...
                    <div className="flex">
                      ...
                      <div>
                        <p className="text-[#555] text-[15px]">
                          ...
                          to identify hazards such as gas leaks, carbon
                          monoxide, mold, and asbestos
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="md:w-2/3">
                    ...
                    <p className="text-[#555] text-[15px] mb-4">
                      Within a few days of the visit, you will receive a
                      detailed report including:
                    </p>

                    <p className="text-[#555] text-[15px] mb-4">
                      A certified auditor, accredited by the Building
                      Performance Institute (BPI), will visit your home to
                    ...
                    <ul className="space-y-4">
                      ...
                      <li className="flex items-start">
                        ...
                        <span className="text-[#555] text-[15px]">
                          ...
                          for issues such as gas leaks, carbon monoxide, mold,
                          and asbestos
                        </span>
                      </li>
                    </ul>
              ...
              <div className="mb-8">
                <div className="flex items-start mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#555] text-[15px]">
                      Ensure key areas of your home are accessible for
                      inspection:
                    </p>
                  </div>
                </div>
                  ...
                  <div className="border rounded-lg p-6 bg-white">
                    ...
                    <div className="flex">
                      ...
                      <div>
                        ...
                        <p className="text-[#555] text-[15px]">
                          If you have pets, consider keeping them in a safe
                          space to ensure the technician can work without
                          interruptions
                        </p>
                      </div>
                    </div>
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                ...
                <p className="text-gray-600">
                  Have questions? You&apos;re not alone — here are answers to
                  the things most homeowners want to know.
                </p>
              </div>
            </div>
            <button onClick={() => toggleSection("faq")}>
              <ChevronRight
                className={`text-[#8bc34a] flex-shrink-0 transition-transform duration-200 ${openSection === "faq" ? "rotate-90" : ""}`}
              />
            </button>
          </div>
