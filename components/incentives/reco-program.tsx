      ...
      >
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-xl font-semibold text-gray-700">
            Rockland Electric Company (Orange & Rockland) Whole Home Energy
            Solutions Program
          </h3>
        </div>
        {isExpanded ? (
        ...
        <div className="px-6 pb-6">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-700 mb-4">
              The Rockland Electric (RECO) Whole Home Energy Solutions Program
              is designed to help homeowners in northern New Jersey take a
              comprehensive, whole-house approach to improving comfort, reducing
              energy waste, and lowering monthly utility costs.
            </p>
            ...
            <div className="space-y-2 mb-4">
              <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-md">
                ...
                <span className="text-gray-700">
                  Rebates up to $6,000, based on modeled energy savings
                </span>
              </div>
              <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-md">
                <CheckCircle size={16} className="text-[#68BEB9] mt-0.5" />
                <span className="text-gray-700">
                  0% interest financing up to $25,000, repaid conveniently on
                  your electric bill
                </span>
              </div>
            </div>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-green-50 rounded-lg border border-green-200">
              ...
              <p className="text-gray-700">
                Rockland Electric provides Home Weatherization for
                Income-Qualified customers as well. For those with moderate
                incomes, the utility will cover the cost of many energy
                efficiency upgrades through its weatherization program.
              </p>
            </div>
          </div>
        </div>
